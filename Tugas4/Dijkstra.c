...
Program digunakan untuk menyimulasikan algoritma dijkstra yang digunakan pada pemetaan kota di kebun raya purwodadi.*/
...
int main (){
    ...
    // Input file kota
    printf("Selamat datang di database kota.\n");
    ...
    while(progress=='y'){
        ...
        scanf(" %d",&idx_tujuan);
        idx_tujuan-=1;
        int jarak_final[n_kota]; //Jarak akhir ke masing2 kota, akan di update terus sesuai jarak yang ditemukan
